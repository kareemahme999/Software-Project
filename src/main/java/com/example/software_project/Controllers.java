...
class LoginController {
    ...
    public LoginController(Stage stage) {
        ...
        // Demo user — change credentials as needed
        this.currentUser = new User(1, "Ahmed", "ahmed@email.com", "pass123", "USD");
    }
...
class BudgetController {
    ...
    public void checkLimit() {
        ...
        switch (budget.getStatus()) {
            ...
            case NEAR_LIMIT:
                view.getStatusLabel().setText("Status: NEAR LIMIT ⚠️");
...
class GoalController {
    ...
    private void refreshProgress() {
        ...
        switch (currentGoal.getStatus()) {
            case COMPLETED: view.getStatusLabel().setStyle("-fx-text-fill: #27ae60; -fx-font-weight: bold;"); view.getProgressBar().setStyle("-fx-accent: #27ae60;"); break;
            case CANCELLED: view.getStatusLabel().setStyle("-fx-text-fill: #e74c3c; -fx-font-weight: bold;"); view.getProgressBar().setStyle("-fx-accent: #e74c3c;"); break;
            default:        view.getStatusLabel().setStyle("-fx-text-fill: #3498db; -fx-font-weight: bold;"); view.getProgressBar().setStyle("-fx-accent: #3498db;");
        }
    }
